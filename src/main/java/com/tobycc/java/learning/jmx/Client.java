...
/*
 * Advanced Client.java - JMX client that interacts with the JMX agent. It gets
 * attributes and performs operations on the Standard MBean and the QueueSampler
 * MXBean example. It also listens for Standard MBean notifications.
 */
...
public class Client {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ----------------------
        // Manage the Standard MBean
        // ----------------------

        echo("\n>>> Perform operations on Standard MBean <<<");

        // Construct the ObjectName for the Standard MBean
        //
        ObjectName mbeanName = new ObjectName("com.example:type=Standard");

        // Create a dedicated proxy for the MBean instead of
        // going directly through the MBean server connection
        //
        StandardMBean mbeanProxy =
                JMX.newMBeanProxy(mbsc, mbeanName, StandardMBean.class, true);

        // Add notification listener on Standard MBean
        //
        echo("\nAdd notification listener...");
        mbsc.addNotificationListener(mbeanName, listener, null, null);

        // Get CacheSize attribute in Standard MBean
        //
        echo("\nCacheSize = " + mbeanProxy.getCacheSize());

        // Set CacheSize attribute in Standard MBean
        // Calling "reset" makes the Standard MBean emit a
        ...
        // Invoke "sayStandard" in Standard MBean
        //
        echo("\nInvoke sayStandard() in Standard MBean...");
        mbeanProxy.sayHello();

        // Invoke "add" in Standard MBean
        //
        echo("\nInvoke add(2, 3) in Standard MBean...");
