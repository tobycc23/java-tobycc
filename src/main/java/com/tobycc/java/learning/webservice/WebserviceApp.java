 ...
 * Created by toby.christey-clover on 23/04/2018.
 ...
 @SpringBootApplication is a convenience annotation that adds all of the following:
   ...
   @ComponentScan tells Spring to look for other components, configurations, and services in the com.test.webservice.hello package, allowing
 ...
 The main() method uses Spring Boot’s SpringApplication.run() method to launch an application. Did you notice that there
   wasn’t a single line of XML? No web.xml file either. This web application is 100% pure Java and you didn’t have to deal
